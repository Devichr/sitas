...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=EB+Garamond:ital,wght@0,400..800;1,400..800&family=Rubik:ital,wght@0,300..900;1,300..900&display=swap" rel="stylesheet">
...
.sidebar-menu {
        transition: transform 0.3s ease, background-color 0.3s ease; /* Menambah animasi transisi */
        background-color: #6482ad; /* Ubah warna latar belakang */
        color: #ecf0f1; /* Ubah warna teks */
    }
